    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div id="world-map"
                            ...
                            <svg width="627.5" height="250">
                                <g transform="scale(0.42158516020236086) translate(264.71500000000003, 0)">
                                    <path
            ...
            <div class="col-6">
                ...
                <div class="card-header bg-gradient-success border-0 ui-sortable-handle" style="cursor: move;">
                    <h3 class="card-title">
                        <i class="far fa-calendar-alt"></i>
                        Calendar
                    </h3>
                ...
                <div class="card-body bg-gradient-success pt-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-action="selectDay" data-day="09/14/2022" class="day">
                                                            14</td>
                                                        <td data-action="selectDay" data-day="09/15/2022" class="day">
                                                            15</td>
